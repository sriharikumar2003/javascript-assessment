...
function lastOcc(arr,tar){
    return arr.firstIndexOf(tar);
}
console.log(lastOcc("He is again a great man is always great","great"));
console.log(firstOcc("He is again a great man is always great","great"));
